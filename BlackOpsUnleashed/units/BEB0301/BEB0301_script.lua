...
BEB0301 = Class(TLandFactoryUnit) {
    OnStopBeingBuilt = function(self)
       if not self:IsDead() then
           ...
           local FactoryB = CreateUnit('ueb0301', self:GetArmy(), location[1], location[2], location[3], myOrientation[1], myOrientation[2], myOrientation[3], myOrientation[4], 'Land')
