...
----------------------------------------------------------------------------------------------------------------------------------------------------
    ShieldEffects = {
       ...
       '/effects/emitters/cybran_shield_05_generator_03_emit.bp', --flashes
       '/effects/emitters/cybran_shield_02_generator_02_emit.bp',
       '/effects/emitters/cybran_shield_02_generator_03_emit.bp',-- flash rest are lightning
       '/effects/emitters/cybran_shield_01_generator_02_emit.bp',
       '/effects/emitters/cybran_shield_04_generator_02_emit.bp',
       '/effects/emitters/cybran_shield_04_generator_03_emit.bp',-- flashes
    },
