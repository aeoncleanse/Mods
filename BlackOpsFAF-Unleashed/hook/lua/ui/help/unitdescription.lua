...
Description['ura0309'] = "<LOC Unit_Description_20006> The Vanisher is the Cybran's Tier 3 transport, equipped with Cloak Field Generators, it can become very useful to a clever Commander."
...
Description['brb4401'] = "<LOC Unit_Description_20015> The Shadow creates an energy field around it and bends light to make it and anything else close by invisible to visual sensors."
...
Description['bel0308'] = "<LOC Unit_Description_10005> Mobile artillery support bot, fires napalm shells at the target while moving and carries secondary short range gauss cannons. Shells burn through buildings especially fast."
...
Description['bel0211'] = "<LOC Unit_Description_10009> Fast and fierce, the Inferno uses Flamethrowers to burn through buildings with extraordinary speed. However, they are less effective against armor, and its fuel tank can be easily ruptured by weapons fire resulting in a violent explosion."
...
Description['bab2404'] = "<LOC Unit_Description_30006> Constructs and Launches the deadly Artemis Satellite, if the satellite is shot down a new one can be constructed at the control center, however if the center is destroyed all active sats crash, only able to support a single satellite per station."
...
Description['bsb5102'] = "<LOC Unit_Description_40011> Low end repair pad, quick to build for early refuel and repair."
