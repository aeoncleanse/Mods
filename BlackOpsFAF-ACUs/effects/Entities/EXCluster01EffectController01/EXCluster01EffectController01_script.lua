-------------------------------------------------------------------------------------------------------------------------
-- File     :  /mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01EffectController01/EXCluster01EffectController01_script.lua
...
EXCluster01EffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Effect01/EXCluster01Effect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
        
        -- Create projectile that controls plume effects
        local PlumeEffectYOffset = 0.0625
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Effect02/EXCluster01Effect02_proj.bp',0,PlumeEffectYOffset,0,0,0,1)        
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Shockwave01/EXCluster01Shockwave01_proj.bp', X * OffsetMod , 0.09375, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Shockwave02/EXCluster01Shockwave02_proj.bp', X * OffsetMod , 0.15625, Z * OffsetMod, X, 0, Z)
    ...
    CreateFlavorPlumes = function(self)
        ...
        for i = 0, (numProjectiles -1) do
            ...
            table.insert(projectiles, self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01FlavorPlume01/EXCluster01FlavorPlume01_proj.bp', 0, 0, 0, xVec, yVec, zVec):SetVelocity(velocity))
        end
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Effect03/EXCluster01Effect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end   
    ...
    CreateGroundPlumeConvectionEffects = function(self,army)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXCluster01Effect05/EXCluster01Effect05_proj.bp', x, RandomFloat(outer_lower_height, outer_upper_height), z, x, 0, z)
