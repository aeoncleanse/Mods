...
-- File     :  /mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyEffectController01/EXBillyEffectController01_script.lua
...
EXBillyEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyEffect01/EXBillyEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
        
        -- Create projectile that controls plume effects
        local PlumeEffectYOffset = 1
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyEffect02/EXBillyEffect02_proj.bp',0,PlumeEffectYOffset,0,0,0,1)        
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyShockwave01/EXBillyShockwave01_proj.bp', X * OffsetMod , 1.5, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyShockwave02/EXBillyShockwave02_proj.bp', X * OffsetMod , 2.5, Z * OffsetMod, X, 0, Z)
    ...
    CreateFlavorPlumes = function(self)
        ...
        for i = 0, (numProjectiles -1) do
            ...
            table.insert(projectiles, self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyFlavorPlume01/EXBillyFlavorPlume01_proj.bp', 0, 0, 0, xVec, yVec, zVec):SetVelocity(velocity))
        end
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyEffect03/EXBillyEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end   
    ...
    do
        ...
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs/effects/Entities/EXBillyEffect05/EXBillyEffect05_proj.bp', x, RandomFloat(outer_lower_height, outer_upper_height), z, x, 0, z)
